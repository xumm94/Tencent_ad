...
##################################################
    ...
    categorical = categorical_features + ['marriageStatus.1', 'ct.1', 'os.1', 'appIdInstall.1', 'appIdAction.1']
...
'''
[2000]	train's auc: 0.740727	valid's auc: 0.726513

Model Report
n_estimators :  2000
auc: 0.726512943451187
'''
